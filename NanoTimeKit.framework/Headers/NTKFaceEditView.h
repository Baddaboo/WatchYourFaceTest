...
@class NSMutableArray, NSString, NTKPageDotsView, PUICClientSideAnimation, UIButton, UIScrollView, UIView, UIViewController;
...
- (void)setForEditMode:(int)arg1 numberOfLisaValues:(unsigned int)arg2 currentValue:(unsigned int)arg3 valueHeight:(float)arg4 animated:(_Bool)arg5;
