...
@class CLKComplicationTemplate, NTKWeatherComplicationDataSource;

@interface NTKWeatherComplicationDataSourceAdapter : NTKComplicationDataSource
{
    NTKWeatherComplicationDataSource *_sharedSource;
    id _sharedSourceUpdater;
