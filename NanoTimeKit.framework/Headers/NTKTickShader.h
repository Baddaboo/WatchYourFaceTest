...
@property(readonly, nonatomic) float filterWidth; // @synthesize filterWidth=_filterWidth;
@property(readonly, nonatomic) float tickWidth; // @synthesize tickWidth=_tickWidth;
// - (void).cxx_destruct;
- (id)init;
