...
@class NMUNowPlayingTimeline, NSHashTable, NSMutableArray, NSObject, NSString, NTKMusicNewUserManager, NTKMusicTimelineEntry, _NTKMusicTimelineEntryList, _NTKOneShotTimer;
