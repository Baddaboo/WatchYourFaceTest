...
//#import "NTKClockStatusBarViewController.h"

@class NSCache, NSDate, NSMutableDictionary, NSObject, NSString, NTKComplicationController, NTKComplicationDisplayWrapperView, NTKDelayedBlock, NTKFace, NTKFaceEditView, NTKFaceView, PUICClientSideAnimation, UIImageView, UIView, UIViewController;
...
@interface NTKFaceViewController : UIViewController <NTKFaceEditViewDelegate, NTKComplicationPickerViewDataSource, NTKFaceObserver, NTKClockIconZoomAnimator, NTKClockHardwareInput, NTKFaceViewDelegate>
{
    ...
    int _dataMode;
    NSDate *_pauseDate;
    UIViewController *_statusBarViewController;
    NTKFace *_face;
}
...
@property(retain, nonatomic) UIViewController *statusBarViewController; // @synthesize statusBarViewController=_statusBarViewController;
